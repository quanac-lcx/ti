...
export const jaJP = {
  ...
  problemset: {
    ...
    mode: {
      ...
      noticePrefix: "試験開始後にカウントダウンが始まります。途中で一時停止でき、解答は一定間隔でローカルとクラウドに自動保存されます（",
      noticeLink: "自動保存間隔の設定はこちら",
      noticeSuffix: "）。誤って更新または閉じた場合はプロフィールから再開できます。",
      correct: "正解",
      wrong: "不正解",
      remainingTime: "残り時間",
      answered: "解答済み",
  ...
  settings: {
    ...enUS.settings,
    autosaveDesc: "制限時間付きテストと自由練習でのローカルおよびクラウドへの自動保存復元に使用されます。これにより、ブラウザやデバイスを切り替えても、同じアカウントにログインすれば解答データを復元できます。",
    title: "設定",
    loading: "設定を読み込み中",
    saved: "設定を保存しました。",
    noticeTitle: "注意",
